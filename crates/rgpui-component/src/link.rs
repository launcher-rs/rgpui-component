...
pub struct Link {
    ...
    disabled: bool,
    on_click: Option<Box<dyn Fn(&ClickEvent, &mut rgpui::Window, &mut rgpui::App) + 'static>>,
...
impl Link {
    ...
    pub fn on_click(
        mut self,
        handler: impl Fn(&ClickEvent, &mut rgpui::Window, &mut rgpui::App) + 'static,
    ) -> Self {
...
impl RenderOnce for Link {
    fn render(self, _: &mut rgpui::Window, cx: &mut rgpui::App) -> impl IntoElement {
