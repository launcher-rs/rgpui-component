...
use crate::input::{RopeExt as _, blink_cursor::CURSOR_WIDTH, display_map::LineLayout};
use rgpui_component::{
    ActiveTheme as _, Colorize, IconName, Selectable, Sizable as _,
...
struct FoldIconLayout {
    ...
    icons: Vec<(usize, bool, rgpui::AnyElement)>,
}
...
impl TextElement {
    ...
    fn layout_cursor(
            ...
            (cursor_pos, cursor_start, cursor_end)
        {
            ...
            let cursor_height = match state.size {
                rgpui_component::Size::Large => 1.,
                rgpui_component::Size::Small => 0.75,
                _ => 0.85,
            } * line_height;
    ...
    pub(crate) fn layout_match_range(
        ...
        let mut builder = rgpui::PathBuilder::fill();
...
fn print_points_as_svg_path(
    line_corners: &Vec<rgpui::Corners<Pixels>>,
...
impl Element for TextElement {
    ...
    fn paint(
        ...
        if let Some(hitbox) = prepaint.hover_definition_hitbox.as_ref() {
            window.set_cursor_style(rgpui::CursorStyle::PointingHand, &hitbox);
        }
